...
SDL_DYNAPI_PROC(SDL_GpuUniformBuffer*,SDL_GpuCreateUniformBuffer,(SDL_GpuDevice *a, Uint32 b),(a,b),return)
...
SDL_DYNAPI_PROC(void,SDL_GpuQueueDestroyUniformBuffer,(SDL_GpuDevice *a, SDL_GpuUniformBuffer *b),(a,b),)
SDL_DYNAPI_PROC(void,SDL_GpuQueueDestroyTransferBuffer,(SDL_GpuDevice *a, SDL_GpuTransferBuffer *b),(a,b),)
SDL_DYNAPI_PROC(void,SDL_GpuQueueDestroyShader,(SDL_GpuDevice *a, SDL_GpuShader *b),(a,b),)
...
SDL_DYNAPI_PROC(void,SDL_GpuQueueDestroyOcclusionQuery,(SDL_GpuDevice *a, SDL_GpuOcclusionQuery *b),(a,b),)
...
SDL_DYNAPI_PROC(void,SDL_GpuBindGraphicsResourceSet,(SDL_GpuRenderPass *a, Uint32 b, SDL_GpuShaderResourceBinding *c, Uint32 d),(a,b,c,d),)
SDL_DYNAPI_PROC(void,SDL_GpuPushGraphicsUniformData,(SDL_GpuRenderPass *a, SDL_GpuUniformBuffer *b, void *c, Uint32 d),(a,b,c,d),)
SDL_DYNAPI_PROC(void,SDL_GpuDrawInstancedPrimitives,(SDL_GpuRenderPass *a, Uint32 b, Uint32 c, Uint32 d, Uint32 e),(a,b,c,d,e),)
...
SDL_DYNAPI_PROC(SDL_GpuComputePass*,SDL_GpuBeginComputePass,(SDL_GpuCommandBuffer *a),(a),return)
SDL_DYNAPI_PROC(void,SDL_GpuBindComputePipeline,(SDL_GpuComputePass *a, SDL_GpuComputePipeline *b),(a,b),)
SDL_DYNAPI_PROC(void,SDL_GpuBindComputeResourceSet,(SDL_GpuComputePass *a, Uint32 b, SDL_GpuShaderResourceBinding *c, Uint32 d),(a,b,c,d),)
...
SDL_DYNAPI_PROC(SDL_bool,SDL_GpuClaimWindow,(SDL_GpuDevice *a, SDL_Window *b, SDL_GpuPresentMode c, SDL_GpuTextureFormat d, SDL_GpuColorSpace e),(a,b,c,d,e),return)
SDL_DYNAPI_PROC(void,SDL_GpuUnclaimWindow,(SDL_GpuDevice *a, SDL_Window *b),(a,b),)
SDL_DYNAPI_PROC(void,SDL_GpuSetSwapchainParameters,(SDL_GpuDevice *a, SDL_Window *b, SDL_GpuPresentMode c, SDL_GpuTextureFormat d, SDL_GpuColorSpace e),(a,b,c,d,e),)
...
SDL_DYNAPI_PROC(void,SDL_GpuOcclusionQueryBegin,(SDL_GpuCommandBuffer *a, SDL_GpuOcclusionQuery *b),(a,b),)
SDL_DYNAPI_PROC(void,SDL_GpuOcclusionQueryEnd,(SDL_GpuCommandBuffer *a, SDL_GpuOcclusionQuery *b),(a,b),)
